...
# Set environment for dev mode license handling
config :wanderer_notifier, environment: :dev
...
# File logging is configured using LoggerBackends in application.ex
