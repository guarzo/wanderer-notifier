defmodule WandererNotifier.MockFeatureExtensions do
  ...
  def add_expectations do
    ...
    Mox.stub(WandererNotifier.Config.MockFeatures, :character_notifications_enabled?, fn ->
      true
    end)

    Mox.stub(WandererNotifier.Config.MockFeatures, :tracked_systems_notifications_enabled?, fn ->
      true
    end)

    Mox.stub(
      WandererNotifier.Config.MockFeatures,
    ...
    Mox.stub(WandererNotifier.Config.MockFeatures, :persistence_enabled?, fn -> true end)
