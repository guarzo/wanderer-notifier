defmodule WandererNotifier.KillmailProcessing.DataAccessTest do
  use ExUnit.Case, async: true

  alias WandererNotifier.KillmailProcessing.{DataAccess, KillmailData}

  describe "debug_info/1" do
    test "extracts debug info from KillmailData" do
