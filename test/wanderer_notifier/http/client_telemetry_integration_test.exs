defmodule WandererNotifier.Http.ClientTelemetryIntegrationTest do
  ...
  describe "HTTP Client with default telemetry middleware" do
    test "emits telemetry events for simple GET request" do
    ...
    test "can override default middleware to exclude telemetry" do
    ...
    test "includes custom telemetry options in metadata" do
      telemetry_options = [
    ...
    test "handles POST requests with body correctly" do
    ...
    test "maintains request ID consistency across events" do
      assert {:error, _} = Client.get("https://httpbin.org/status/500")
