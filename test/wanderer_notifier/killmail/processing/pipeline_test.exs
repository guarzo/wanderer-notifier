defmodule WandererNotifier.Killmail.Processing.PipelineTest do
  ...
  describe "Data integration" do
    test "pipeline works with Data structs" do
      # Simple zkb data
      zkb_data = %{
        "killmail_id" => 12_345,
        "zkb" => %{
      ...
      # Create a Data struct directly
      {:ok, killmail_data} = Data.from_zkb_and_esi(zkb_data, esi_data)

      # Verify it's a Data struct
      assert %Data{} = killmail_data
