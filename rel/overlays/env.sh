...
export STATUS_MESSAGES_ENABLED="${STATUS_MESSAGES_ENABLED:-${WANDERER_STATUS_MESSAGES_ENABLED:-true}}"
export WANDERER_STATUS_MESSAGES_ENABLED="${WANDERER_STATUS_MESSAGES_ENABLED:-${STATUS_MESSAGES_ENABLED:-true}}"
