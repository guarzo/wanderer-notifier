...
export STATUS_MESSAGES_ENABLED="${STATUS_MESSAGES_ENABLED:-${WANDERER_STATUS_MESSAGES_ENABLED:-false}}"
export WANDERER_STATUS_MESSAGES_ENABLED="${WANDERER_STATUS_MESSAGES_ENABLED:-${STATUS_MESSAGES_ENABLED:-false}}"
