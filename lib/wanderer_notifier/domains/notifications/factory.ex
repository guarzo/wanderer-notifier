defmodule WandererNotifier.Domains.Notifications.Dispatcher do
  @moduledoc """
  Dispatcher for creating and sending notifications.
  Provides a unified interface for sending notifications of various types.
  """
  @behaviour WandererNotifier.Domains.Notifications.DispatcherBehaviour
  ...
  alias WandererNotifier.Domains.Notifications.Notifiers.TestNotifier
