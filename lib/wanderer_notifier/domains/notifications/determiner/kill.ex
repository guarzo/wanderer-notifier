defmodule WandererNotifier.Domains.Notifications.Determiner.Kill do
  @moduledoc """
  ...
  defp get_config do
    config_module = Application.get_env(:wanderer_notifier, :config_module, Config)
    {:ok, config_module.get_config()}
  end
