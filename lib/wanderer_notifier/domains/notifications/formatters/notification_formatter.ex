defmodule WandererNotifier.Domains.Notifications.Formatters.NotificationFormatter do
  ...
  def format_notification(%Killmail{} = killmail, opts) do
    KillmailFormatter.format(killmail, opts)
  end
  ...
  def format_notification(%System{} = system, _opts) do
    Logger.debug(
  ...
  def format_notification(%{solar_system_id: _} = system_map, _opts)
