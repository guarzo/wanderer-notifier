defmodule WandererNotifier.Domains.Tracking.MapTrackingClient do
  ...
  """
  @spec fetch_and_cache_characters(boolean() | MapConfig.t()) :: {:ok, list()} | {:error, term()}
  ...
  def fetch_and_cache_characters(%MapConfig{} = map_config) do
    fetch_and_cache_entities_for_map(map_config, :characters, false)
  end
  ...
  Optional skip_notifications parameter prevents notifications during initial load.
  """
  @spec fetch_and_cache_systems(boolean() | MapConfig.t()) :: {:ok, list()} | {:error, term()}
  ...
  def fetch_and_cache_systems(%MapConfig{} = map_config) do
    fetch_and_cache_entities_for_map(map_config, :systems, false)
  end
