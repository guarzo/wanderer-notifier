defmodule WandererNotifier.Application.Supervisors.Schedulers.ServiceStatusScheduler do
  @moduledoc """
  ...
  @behaviour WandererNotifier.Application.Supervisors.Schedulers.Scheduler
