defmodule WandererNotifier.Application.Supervisors.Schedulers.BaseMapScheduler do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour WandererNotifier.Application.Supervisors.Schedulers.BaseMapScheduler
      use GenServer
      require Logger
      ...
      def handle_continue(:schedule, state) do
        ...
        if feature_enabled do
          ...
          should_log =
            case __MODULE__ do
              WandererNotifier.Application.Supervisors.Schedulers.SystemUpdateScheduler ->
                not WandererNotifier.Shared.Config.feature_enabled?(
                  :system_polling_disabled_for_sse
                )

              WandererNotifier.Application.Supervisors.Schedulers.CharacterUpdateScheduler ->
                not WandererNotifier.Shared.Config.feature_enabled?(
