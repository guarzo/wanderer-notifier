defmodule WandererNotifier.Http.Middleware.Retry do
  @moduledoc """
  ...
  transient failures gracefully. It uses the existing WandererNotifier.Http.Utils.Retry
  ...
  alias WandererNotifier.Http.Utils.Retry, as: RetryUtils
