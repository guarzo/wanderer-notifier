  ...
  defp process_results(results) do
    ...
    Enum.each(results, fn
      {:ok, type, count} ->
        ...
        case type do
          "systems" ->
            WandererNotifier.Application.Services.ApplicationService.set_tracked_count(:systems, count)

          "characters" ->
            WandererNotifier.Application.Services.ApplicationService.set_tracked_count(:characters, count)
