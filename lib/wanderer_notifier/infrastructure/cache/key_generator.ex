defmodule WandererNotifier.Infrastructure.Cache.KeyGenerator do
  @moduledoc """
  ...
  defmacro defkey(name, prefix, entity, _opts \\ []) do
    quote do
      ...
      def unquote(name)(id, extra \\ nil) do
        WandererNotifier.Infrastructure.Cache.KeyGenerator.combine(
  ...
  defmacro defkey_simple(name, prefix, suffix \\ nil) do
    ...
    quote do
      ...
      def unquote(name)() do
        WandererNotifier.Infrastructure.Cache.KeyGenerator.combine(unquote(parts_expr), [], nil)
      end
    end
  end
