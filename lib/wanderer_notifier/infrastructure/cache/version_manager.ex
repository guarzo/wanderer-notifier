defmodule WandererNotifier.Infrastructure.Cache.VersionManager do
  @moduledoc """
  ...
  # Handle deployment
  WandererNotifier.Infrastructure.Cache.VersionManager.handle_deployment("2.1.0")

  # Rollback to previous version
  WandererNotifier.Infrastructure.Cache.VersionManager.rollback()
  ```
  """
  ...
  alias WandererNotifier.Shared.Config.Version
  ...
  defp register_default_hooks do
    ...
    Versioning.register_deployment_hook(:performance_monitoring, fn old_version, new_version ->
      ...
      try do
        WandererNotifier.Infrastructure.Cache.Metrics.reset_metrics()
      rescue
        error ->
