defmodule WandererNotifier.Infrastructure.Cache.PerformanceMonitor do
  @moduledoc """
  ...
  ```elixir
  config :wanderer_notifier, WandererNotifier.Infrastructure.Cache.PerformanceMonitor,
  ...
  ```elixir
  # Start monitoring
  WandererNotifier.Infrastructure.Cache.PerformanceMonitor.start_monitoring()

  # Check current status
  status = WandererNotifier.Infrastructure.Cache.PerformanceMonitor.get_status()

  # Get performance report
  report = WandererNotifier.Infrastructure.Cache.PerformanceMonitor.get_performance_report()
  ```
  """
