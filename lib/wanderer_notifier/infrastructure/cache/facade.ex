defmodule WandererNotifier.Infrastructure.Cache.Facade do
  @moduledoc """
  ...
  ```elixir
  # Get character data
  {:ok, character} = WandererNotifier.Infrastructure.Cache.Facade.get_character(123456)

  # Get system information
  {:ok, system} = WandererNotifier.Infrastructure.Cache.Facade.get_system(30000142)

  # Store with custom TTL
  :ok = WandererNotifier.Infrastructure.Cache.Facade.put_with_ttl("custom:key", value, 3600)
  ```
  """
  ...
  alias WandererNotifier.Infrastructure.Cache.Versioning
  ...
  ## Examples
      iex> WandererNotifier.Infrastructure.Cache.Facade.get_character(123456)
      {:ok, %{id: 123456, name: "Test Character", corporation_id: 98765}}

      iex> WandererNotifier.Infrastructure.Cache.Facade.get_character(999999)
      {:error, :not_found}
  """
  ...
  defp log_cache_access(domain, id, result, duration \\ 0) do
    ...
    try do
      ...
      WandererNotifier.Infrastructure.Cache.Analytics.record_operation(
        :get,
        key,
        result,
        duration,
