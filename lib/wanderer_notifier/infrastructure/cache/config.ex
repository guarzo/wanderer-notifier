defmodule WandererNotifier.Infrastructure.Cache.Config do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> WandererNotifier.Infrastructure.Cache.Config.cache_name()
      :wanderer_cache
  ...
  ## Examples
      ...
      iex> WandererNotifier.Infrastructure.Cache.Config.cache_name(cache_name: :custom_cache)
      :custom_cache
  """
  ...
  ## Examples
      ...
      iex> WandererNotifier.Infrastructure.Cache.Config.cache_config()
      [
        name: :wanderer_cache,
  ...
  ## Examples
      ...
      iex> WandererNotifier.Infrastructure.Cache.Config.ttl_for(:character)
      86400  # 24 hours
      
      iex> WandererNotifier.Infrastructure.Cache.Config.ttl_for(:killmail)
      3600   # 1 hour
  """
