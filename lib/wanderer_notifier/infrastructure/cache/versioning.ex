defmodule WandererNotifier.Infrastructure.Cache.Versioning do
  @moduledoc """
  ...
  ```elixir
  # Get current version
  version = WandererNotifier.Infrastructure.Cache.Versioning.current_version()

  # Generate versioned key
  key = WandererNotifier.Infrastructure.Cache.Versioning.versioned_key("user:123", version)

  # Invalidate old versions
  WandererNotifier.Infrastructure.Cache.Versioning.invalidate_old_versions("2.0.0")
  ```
  """
