defmodule WandererNotifier.Infrastructure.Cache.Metrics do
  @moduledoc """
  ...
  WandererNotifier.Infrastructure.Cache.Metrics.record_hit(:character, 123456)
  WandererNotifier.Infrastructure.Cache.Metrics.record_miss(:character, 123456)

  # Record operation timing
  WandererNotifier.Infrastructure.Cache.Metrics.record_operation_time(:get, 15)

  # Get current metrics
  metrics = WandererNotifier.Infrastructure.Cache.Metrics.get_metrics()
  ```
  """
  ...
  defp collect_memory_usage do
    try do
      ...
      case WandererNotifier.Infrastructure.Cache.Adapter.adapter() do
        Cachex ->
