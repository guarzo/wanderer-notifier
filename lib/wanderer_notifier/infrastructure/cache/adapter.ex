defmodule WandererNotifier.Infrastructure.Cache.Adapter do
  @moduledoc """
  ...
  def get(cache_name, key) do
    case adapter() do
      ...
      WandererNotifier.Infrastructure.Cache.ETSCache ->
        WandererNotifier.Infrastructure.Cache.ETSCache.get(key, table: cache_name)
  ...
  defp do_set(WandererNotifier.Infrastructure.Cache.ETSCache, cache_name, key, value, ttl) do
    WandererNotifier.Infrastructure.Cache.ETSCache.set(key, value, ttl, table: cache_name)
  end
  ...
  def put(cache_name, key, value) do
    case adapter() do
      ...
      WandererNotifier.Infrastructure.Cache.ETSCache ->
        WandererNotifier.Infrastructure.Cache.ETSCache.put(key, value, table: cache_name)
  ...
  def del(cache_name, key) do
    case adapter() do
      ...
      WandererNotifier.Infrastructure.Cache.ETSCache ->
        case WandererNotifier.Infrastructure.Cache.ETSCache.delete(key, table: cache_name) do
          :ok -> {:ok, true}
          error -> error
        end
  ...
  def clear(cache_name) do
    case adapter() do
      ...
      WandererNotifier.Infrastructure.Cache.ETSCache ->
        case WandererNotifier.Infrastructure.Cache.ETSCache.clear(table: cache_name) do
          :ok -> {:ok, true}
          error -> error
        end
