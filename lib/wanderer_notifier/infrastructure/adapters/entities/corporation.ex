defmodule WandererNotifier.Infrastructure.Adapters.ESI.Entities.Corporation do
  @moduledoc """
  ...
  ## Example
      iex> WandererNotifier.Infrastructure.Adapters.ESI.Entities.Corporation.from_esi_data(%{
      ...
      ...> })
      %WandererNotifier.Infrastructure.Adapters.ESI.Entities.Corporation{
        corporation_id: 789_012,
        name: "Test Corporation",
        ticker: "TSTC",
        member_count: 100,
