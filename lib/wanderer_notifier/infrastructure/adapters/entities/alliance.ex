defmodule WandererNotifier.Infrastructure.Adapters.ESI.Entities.Alliance do
  @moduledoc """
  ...
  ## Example
      iex> WandererNotifier.Infrastructure.Adapters.ESI.Entities.Alliance.from_esi_data(%{
      ...>   "alliance_id" => 345_678,
      ...>   "name" => "Test Alliance",
      ...>   "ticker" => "TSTA",
      ...
      ...>   "faction_id" => 555_555
      ...> })
      %WandererNotifier.Infrastructure.Adapters.ESI.Entities.Alliance{
        alliance_id: 345_678,
        name: "Test Alliance",
        ticker: "TSTA",
        executor_corporation_id: 789_012,
