defmodule WandererNotifier.Infrastructure.Adapters.ESI.Entities.SolarSystem do
  @moduledoc """
  ...
  ## Example
      iex> WandererNotifier.Infrastructure.Adapters.ESI.Entities.SolarSystem.from_esi_data(%{
      ...>   "system_id" => 30000142,
      ...>   "name" => "Jita",
      ...
      ...> })
      %WandererNotifier.Infrastructure.Adapters.ESI.Entities.SolarSystem{
        system_id: 30000142,
        name: "Jita",
        constellation_id: 20000020,
        constellation_name: "Test Constellation",
