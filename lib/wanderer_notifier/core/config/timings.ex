defmodule WandererNotifier.Core.Config.Timings do
  @moduledoc """
  ...
  """
  def character_update_scheduler_interval, do: 30 * 60 * 1000
  
  @doc """
  Interval for system data updates (60 minutes)
  """
  def system_update_scheduler_interval, do: 60 * 60 * 1000
