defmodule WandererNotifier.KillmailProcessing.Validator do
  ...
  The validator is designed to validate KillmailData structs directly, checking
  ...
  ## Parameters
  - `killmail`: A KillmailData struct to validate
  ...
  def validate(other) do
    {:error, [{:invalid_type, "Expected KillmailData struct, got: #{inspect(other)}"}]}
  end
  ...
  def has_minimum_required_data?(%KillmailData{} = killmail) do
  ...
  def log_validation_errors(%KillmailData{} = killmail, errors) do
