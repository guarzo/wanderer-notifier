defmodule WandererNotifier.Cache.Insights do
  @moduledoc """
  ...
  health = WandererNotifier.Cache.Insights.get_health_score()

  # Get optimization recommendations
  recommendations = WandererNotifier.Cache.Insights.get_optimization_recommendations()

  # Get dashboard data
  dashboard = WandererNotifier.Cache.Insights.get_dashboard_data()

  # Generate performance report
  report = WandererNotifier.Cache.Insights.generate_performance_report()
  ```
  """
