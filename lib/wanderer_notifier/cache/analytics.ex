defmodule WandererNotifier.Cache.Analytics do
  @moduledoc """
  ...
  # Get usage report
  report = WandererNotifier.Cache.Analytics.get_usage_report()

  # Get efficiency metrics
  metrics = WandererNotifier.Cache.Analytics.get_efficiency_metrics()

  # Analyze cache patterns
  patterns = WandererNotifier.Cache.Analytics.analyze_patterns()
  ```
  """
