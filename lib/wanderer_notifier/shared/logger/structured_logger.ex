defmodule WandererNotifier.Shared.Logger.StructuredLogger do
  @moduledoc """
  ...
  ```elixir
  import WandererNotifier.Shared.Logger.StructuredLogger
  ...
  alias WandererNotifier.Shared.Logger.MetadataKeys
  ...
  defmacro log_info(message, metadata \\ []) do
    quote do
      require WandererNotifier.Shared.Logger.Logger
